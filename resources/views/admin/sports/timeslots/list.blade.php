                ...
                <div class="card-body">
                    ...
                    <div id="timeslotsContent">
                        ...
                        @foreach($timeslots as $timeslot)
                            <li id="timeslot_{{ $timeslot->id }}" class="list-group-item d-flex justify-content-between align-items-center">                                <span class="timeslot">{{ __("$timeslot->start_time -> $timeslot->end_time") }}</span>
                                <div>
