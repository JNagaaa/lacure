        ...
        <div class="col-md-8">
            <div style="border: 1px solid #FFA500; padding: 25px; border-radius: 10px; background-color: #555555;">
                ...
                <div class="me-1 ms-1">
                    ...
                    @endif
                    <a href="/admin/sports/news/create" class="btn btn-primary d-flex justify-content-center" style="background-color: #FFA500; border-color: #FFA500;">
                        ...
                        @if(isset($allNews))
                            @foreach($allNews as $news)
                                <li class="list-group-item d-flex justify-content-between align-items-center" style="background-color: #555555;">
                                    <a href="{{ url('admin/sports/news/edit/'.$news->id) }}" style="color: #343a40; text-decoration: none;">
