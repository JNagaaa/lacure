            ...
            <div class="col-md-10 col-sm-12">
                <div style="border: 1px solid #FFA500; padding: 25px; border-radius: 10px; background-color: #555555;">
                    <div class="text-center">
                        ...
                        <p>Votre destination privilégiée pour une expérience culinaire inoubliable et des moments sportifs mémorables!</p>
                    </div>

                    <div class="row mt-4">
                        <div class="col-md-4 text-center">
                            <h2>Menu du Restaurant</h2>
                            <img src="path/to/food-image.jpg" alt="Image du plat" style="width:100%; border-radius: 10px;"/>
                        ...
                        <div class="col-md-4 text-center">
                            ...
                            <img src="path/to/table-image.jpg" alt="Image de la table du restaurant" style="width:100%; border-radius: 10px;"/>
                        ...
                        <div class="col-md-4 text-center">
                            ...
                            <img src="path/to/terrain-image.jpg" alt="Image des terrains de padel et de tennis" style="width:100%; border-radius: 10px;"/>
